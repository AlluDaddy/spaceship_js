...
Collision : -
        ...
        If Bullet reaches the surface of the spaceship(enemy). -> (offsetLeft)
        The spaceship should be disappear and Number of kills are incerased by one. -> (visibility= "hidden")
        If the total number of kills is equal to 3, then the game shows an alert message i.e "Game is over".
